...
CREATE TABLE IF NOT EXISTS `avito_avto` (
  ...
  `color` VARCHAR(100) NULL COMMENT 'цвет',
  ...
  `year_of_manufacture` VARCHAR(45) NULL,
...
START TRANSACTION;
USE `osint`;
INSERT INTO `dict_load_file` (`id`, `name`, `status`) VALUES (1, 'получена информация', 1);
INSERT INTO `dict_load_file` (`id`, `name`, `status`) VALUES (2, 'поставлен в очередь', 2);
INSERT INTO `dict_load_file` (`id`, `name`, `status`) VALUES (3, 'залит в БД', 3);
