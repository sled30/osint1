...
$load_dir="/home/sled/avito/upload/in/";
echo 1;
$sql_get_file="select id, name from loadd_file where dict_load_file_id=1 and source_id='2'";
...
#  mysqli_query($connect, $sql_update_status);
  $rename_load="/home/sled/avito/upload/load/";
  #echo $load_file ."\n";
